...
class M_Dispersa{
    ...
    insert(x,y,isbn,nombre_autor,nombre_libro,cantidad,paginas,categoria){
        var newCell = new Node_Dispersa(x,y,isbn,nombre_autor,nombre_libro,cantidad,paginas,categoria);
    ...
    graph_matrix(){
        ...
        codigodot+="label = \""+"CATEGORÍA THRILLER"+"\";\n"
        ...
        while (auxc != null){
            var aux = auxc.access;
            while (aux != null){
                codigodot+="M"+aux.x+"N"+aux.y+"[label = \""+aux.nombre_libro+"\", group = "+(aux.x + 1)+"];\n"
                aux = aux.down;
            }
            auxc = auxc.next;
        }
        ...
        d3.select("#lienzo_thriller1").graphviz()
            .width(1000)
            .height(1000)
            .renderDot(codigodot)
    ...
    graficar(){
        ...
        while(aux!=null){
            ...
            while(aux2!=null){
                ...
                console.log("Pos"+"["+aux2.x +","+aux2.y+"]"+ " Valor :"+aux2.libro)
                aux2=aux2.down
